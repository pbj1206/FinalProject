...
<c:set var="contextPath" value="${pageContext.request.contextPath }"/>
  ...
  <title>SynerHub login</title>
</head>

<body>
  <!-- Preloader -->
  <div class="preloader">
    <img src="${contextPath }/resources/assets/images/logos/logo2.png" alt="loader" class="lds-ripple img-fluid" style="object-fit: cover; width: 100%; height: 100%;" />
  </div>
