                ...
                <div class="col-lg-12">
                  ...
                  <div class="card">
					...
					<!-- 시작 인덱스 계산 -->
                      <!-- <div class="card p-3"> -->
                      <div class="d-flex justify-content-between align-items-center"> 
                       	<a href="${contextPath}/admin/qna/unanswered" id="unAnswerBtn" class="btn bg-warning-subtle text-warning mb-3">
						    답변 대기 : ${unAnsweredCount}건 
						</a>
...
function drawBasic(month) {
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById('month_total_posts').innerText = month + '월 게시글 수: ' + monthTotalPosts + ' 개'; 
        },
